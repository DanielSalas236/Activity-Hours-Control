...
require("connections/db_connect.php");
    $iduser=$_SESSION["id"];
    $consulta="SELECT u.avatar, u.telefono, u.direccion, a.descripcionactividad actividad FROM actividad a, usuario_actividad ua, usuario u WHERE ua.codactividad=a.idactividad AND ua.usuario_idusuario=u.idusuario AND ua.usuario_idusuario='$iduser'";
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-item nav-link active" href="https://spinchk.com/inicio">Inicio <span class="sr-only">(current)</span></a>
        ...
        <div class="informacion">
            <div class="container">
                ...
                <div class="row">
                    <div class="perfil">
                        <div class="avatar">
                            <img width="200px"  height="200px" src="<?php echo $f['avatar'] ?>" alt="userimage" class="img-thumbnail rounded-circle">
                        </div>
                    </div>
                </div>
                <br><br>
                ...
                <div class="row">
                    ...
                    ?>
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Horas BU:
                                    <?php echo $_SESSION['horas']; ?>
                                </h5>
                                <p class="card-text">ID Usuario
                                    <?php echo $_SESSION['id']; ?>
                                </p>
                                <p class="card-text">Actividad:
                                    <?php echo $f['actividad']; ?>
                                </p>
                            </div>
                        </div>
                    </div>
